...
int	is_ignored(int current, int state)
{
	if ((current == START_STATE && state == D_QUOTE_STATE)
		...
		|| (current == EQUAL_STATE && state == D_QUOTE_STATE)
		|| (current == DOLLAR_STATE && state == D_QUOTE_STATE)
		...
		|| (current == EQUAL_STATE && state == S_QUOTE_STATE)
		|| (current == DOLLAR_STATE && state == S_QUOTE_STATE)
